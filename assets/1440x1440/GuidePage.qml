...
Page {
    ...
    property int downX;
    property double moveThreshold: ui.du(12)
    property int currentPage: 0
    property int howManyPages: 5
    property int displayWidth: ui.du(120)
    property int displayHeight: ui.du(120)
        ...
        ScrollView {
            ...
            Container {
                ...
                ImageView {
                    ...
                    imageSource: "asset:///images/allguides_q30_small.jpg"
                }
                Button {
                    translationX: ui.du(520)
                    translationY: ui.du(110)
                    id: closeBtn
                    text: "Enter"
                    onClicked: {
                        nav.pop();
